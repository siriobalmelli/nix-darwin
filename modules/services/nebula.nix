      ...
      type = types.attrsOf (
        types.submodule {
          options = {
            ...
            isLighthouse = mkEnableOption "lighthouse functionality for this node";

            isRelay = mkEnableOption "relay functionality for this node";
            ...
            tun.disabled = mkOption {
              type = types.bool;
              default = false;
              description = ''
                When true, a lighthouse can be started without a local tun interface (and therefore without root).
              '';
            };
            ...
            tun.device = mkOption {
              ...
              default = null;
              description = ''
                Name of the tun device. When unset, nebula selects a platform-appropriate
                default (on Darwin this will be a utun interface).
              '';
            };
      ...
      mapAttrsToList (
        ...
        let
          settings = recursiveUpdate {
            ...
            tun = {
              disabled = netCfg.tun.disabled;
            }
            // optionalAttrs (netCfg.tun.device != null) {
